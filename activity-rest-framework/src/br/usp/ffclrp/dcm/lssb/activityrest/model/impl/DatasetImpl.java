 ...
 * </p>
 * <ul>
 *   <li>{@link br.usp.ffclrp.dcm.lssb.activityrest.model.impl.DatasetImpl#getName <em>Name</em>}</li>
 *   <li>{@link br.usp.ffclrp.dcm.lssb.activityrest.model.impl.DatasetImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link br.usp.ffclrp.dcm.lssb.activityrest.model.impl.DatasetImpl#getFiles <em>Files</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatasetImpl extends MinimalEObjectImpl.Container implements Dataset {
	...
	protected EClass eStaticClass() {
		return ActivityPackage.Literals.DATASET;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityPackage.DATASET__NAME, oldName, name));
	}
	...
	public br.usp.ffclrp.dcm.lssb.restaurant.analysisactivitydescription.Dataset getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityPackage.DATASET__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(br.usp.ffclrp.dcm.lssb.restaurant.analysisactivitydescription.Dataset newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityPackage.DATASET__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<File> getFiles() {
		if (files == null) {
			files = new EDataTypeUniqueEList<File>(File.class, this, ActivityPackage.DATASET__FILES);
		}
		return files;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityPackage.DATASET__NAME:
				return getName();
			case ActivityPackage.DATASET__DESCRIPTION:
				if (resolve) return getDescription();
				return basicGetDescription();
			case ActivityPackage.DATASET__FILES:
				return getFiles();
		}
