 ...
 * </p>
 * <ul>
 *   <li>{@link br.usp.ffclrp.dcm.lssb.activityrest.model.impl.ValidationResultImpl#getIsValid <em>Is Valid</em>}</li>
 *   <li>{@link br.usp.ffclrp.dcm.lssb.activityrest.model.impl.ValidationResultImpl#getInvalidValues <em>Invalid Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValidationResultImpl extends MinimalEObjectImpl.Container implements ValidationResult {
	...
	protected EClass eStaticClass() {
		return ActivityPackage.Literals.VALIDATION_RESULT;
	}
	...
	public void setIsValid(Boolean newIsValid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityPackage.VALIDATION_RESULT__IS_VALID, oldIsValid, isValid));
	}
	...
	public Map<String, Object> getInvalidValues() {
		if (invalidValues != null && ((EObject)invalidValues).eIsProxy()) {
			...
			if (invalidValues != oldInvalidValues) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityPackage.VALIDATION_RESULT__INVALID_VALUES, oldInvalidValues, invalidValues));
			}
		}
	...
	public void setInvalidValues(Map<String, Object> newInvalidValues) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityPackage.VALIDATION_RESULT__INVALID_VALUES, oldInvalidValues, invalidValues));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityPackage.VALIDATION_RESULT__IS_VALID:
				return getIsValid();
			case ActivityPackage.VALIDATION_RESULT__INVALID_VALUES:
