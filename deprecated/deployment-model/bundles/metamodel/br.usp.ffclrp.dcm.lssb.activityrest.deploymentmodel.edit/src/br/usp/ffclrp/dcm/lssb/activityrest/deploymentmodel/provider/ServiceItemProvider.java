...
/**
 * This is the item provider adapter for a {@link br.usp.ffclrp.dcm.lssb.activityrest.deploymentmodel.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeploymentModelPackage.Literals.SERVICE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addApiVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_apiVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_apiVersion_feature", "_UI_Service_type"),
				 DeploymentModelPackage.Literals.SERVICE__API_VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeploymentModelPackage.Literals.SERVICE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
