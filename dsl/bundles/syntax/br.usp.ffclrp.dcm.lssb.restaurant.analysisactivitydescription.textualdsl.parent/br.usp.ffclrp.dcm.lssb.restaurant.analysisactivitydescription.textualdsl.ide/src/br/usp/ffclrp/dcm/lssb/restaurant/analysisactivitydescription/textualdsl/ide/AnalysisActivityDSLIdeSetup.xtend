 ...
 */
class AnalysisActivityDSLIdeSetup extends AnalysisActivityDSLStandaloneSetup {

	override createInjector() {
		Guice.createInjector(Modules2.mixin(new AnalysisActivityDSLRuntimeModule, new AnalysisActivityDSLIdeModule))
	}
