...
import br.usp.ffclrp.dcm.lssb.restaurant.analysisactivitydescription.textualdsl.web.AnalysisActivityDSLWebSetup;
...
public class AnalysisActivityDSLServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new AnalysisActivityDSLWebSetup().createInjectorAndDoEMFRegistration();
