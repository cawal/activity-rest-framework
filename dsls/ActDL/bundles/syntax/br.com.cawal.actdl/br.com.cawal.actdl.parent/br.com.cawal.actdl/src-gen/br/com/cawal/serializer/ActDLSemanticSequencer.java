...
public class ActDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == AnalysisActivityDescriptionPackage.eINSTANCE)
			...
			case StringListManipulatorsPackage.TO_FLAG:
				sequence_ToFlag(context, (ToFlag) semanticObject); 
				return; 
			}
	...
	/**
	 * Contexts:
	 *     StringListManipulator returns ToFlag
	 *     ToFlag returns ToFlag
	 *
	 * Constraint:
	 *     (ifTrue=EString | ifFalse=EString)*
	 */
	protected void sequence_ToFlag(ISerializationContext context, ToFlag semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
