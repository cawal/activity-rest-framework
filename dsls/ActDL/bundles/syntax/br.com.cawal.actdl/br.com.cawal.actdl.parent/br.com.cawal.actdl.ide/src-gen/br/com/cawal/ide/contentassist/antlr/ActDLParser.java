 ...
 */
package br.com.cawal.ide.contentassist.antlr;

import br.com.cawal.ide.contentassist.antlr.internal.InternalActDLParser;
...
public class ActDLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ActDLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ActDLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getToFlagAccess().getGroup(), "rule__ToFlag__Group__0");
			builder.put(grammarAccess.getToFlagAccess().getGroup_3_0(), "rule__ToFlag__Group_3_0__0");
			builder.put(grammarAccess.getToFlagAccess().getGroup_3_1(), "rule__ToFlag__Group_3_1__0");
			...
			builder.put(grammarAccess.getToFlagAccess().getIfTrueAssignment_3_0_1(), "rule__ToFlag__IfTrueAssignment_3_0_1");
			builder.put(grammarAccess.getToFlagAccess().getIfFalseAssignment_3_1_1(), "rule__ToFlag__IfFalseAssignment_3_1_1");
			builder.put(grammarAccess.getCommandLineToolAccess().getUnorderedGroup_4_2(), "rule__CommandLineTool__UnorderedGroup_4_2");
			builder.put(grammarAccess.getToFlagAccess().getUnorderedGroup_3(), "rule__ToFlag__UnorderedGroup_3");
		}
	}
	...
	@Override
	protected InternalActDLParser createParser() {
		InternalActDLParser result = new InternalActDLParser(null);
