...
/**
 * This is the item provider adapter for a {@link br.usp.ffclrp.dcm.lssb.restaurant.analysisactivitydescription.Tool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tool_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tool_name_feature", "_UI_Tool_type"),
				 AnalysisActivityDescriptionPackage.Literals.TOOL__NAME,
				 true,
				 false,
				 false,
