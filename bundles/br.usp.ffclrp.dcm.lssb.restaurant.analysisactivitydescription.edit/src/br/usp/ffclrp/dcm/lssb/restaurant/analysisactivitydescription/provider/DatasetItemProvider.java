...
/**
 * This is the item provider adapter for a {@link br.usp.ffclrp.dcm.lssb.restaurant.analysisactivitydescription.Dataset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatasetItemProvider extends MultiplicityElementItemProvider {
	/**
	...
	protected void addMimetypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dataset_mimetype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dataset_mimetype_feature", "_UI_Dataset_type"),
				 AnalysisActivityDescriptionPackage.Literals.DATASET__MIMETYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnalysisActivityDescriptionPackage.Literals.DATASET__CONSTRAINTS);
		}
