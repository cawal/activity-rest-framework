...
/**
 * This is the item provider adapter for a {@link br.usp.ffclrp.dcm.lssb.restaurant.analysisactivitydescription.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AnalysisActivityDescriptionPackage.Literals.ACTIVITY__NAME,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AnalysisActivityDescriptionPackage.Literals.ACTIVITY__PARAMETERS,
				 AnalysisActivityDescriptionFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(AnalysisActivityDescriptionPackage.Literals.ACTIVITY__INPUT_DATASETS,
				 AnalysisActivityDescriptionFactory.eINSTANCE.createInputDataset()));

		newChildDescriptors.add
			(createChildParameter
				(AnalysisActivityDescriptionPackage.Literals.ACTIVITY__OUTPUT_DATASETS,
				 AnalysisActivityDescriptionFactory.eINSTANCE.createOutputDataset()));
