...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Dataset Kinds</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see br.usp.ffclrp.dcm.lssb.restaurant.analysisactivitydescription.AnalysisActivityDescriptionPackage#getDatasetKinds()
 * @model
 * @generated
 */
public enum DatasetKinds implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Dataset Kinds</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DatasetKinds[] VALUES_ARRAY =
		new DatasetKinds[] {
			STANDARD_INPUT,
			STANDARD_OUTPUT,
			STANDARD_ERROR,
	...
	/**
	 * A public read-only list of all the '<em><b>Dataset Kinds</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DatasetKinds> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Dataset Kinds</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DatasetKinds get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DatasetKinds result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dataset Kinds</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static DatasetKinds getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DatasetKinds result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dataset Kinds</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DatasetKinds get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DatasetKinds(int value, String name, String literal) {
		this.value = value;
		this.name = name;
