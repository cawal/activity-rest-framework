 ...
 * @generated
 */
public class AnalysisActivityImpl extends MinimalEObjectImpl.Container implements AnalysisActivity {
	/**
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, AnalysisActivityModelPackage.ANALYSIS_ACTIVITY__PARAMETERS);
		}
		return parameters;
	}
