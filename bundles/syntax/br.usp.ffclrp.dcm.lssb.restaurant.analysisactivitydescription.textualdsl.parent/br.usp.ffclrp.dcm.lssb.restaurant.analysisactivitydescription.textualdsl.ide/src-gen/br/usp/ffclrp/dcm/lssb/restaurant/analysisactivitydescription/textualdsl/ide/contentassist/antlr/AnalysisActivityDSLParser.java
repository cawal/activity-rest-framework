...
public class AnalysisActivityDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AnalysisActivityDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getActivityAccess().getRemarksAssignment_3_1(), "rule__Activity__RemarksAssignment_3_1");
			...
			builder.put(grammarAccess.getParameterAccess().getRemarksAssignment_10_1_1(), "rule__Parameter__RemarksAssignment_10_1_1");
			...
			builder.put(grammarAccess.getInputDatasetAccess().getRemarksAssignment_9_1_1(), "rule__InputDataset__RemarksAssignment_9_1_1");
			...
			builder.put(grammarAccess.getOutputDatasetAccess().getRemarksAssignment_9_1_1(), "rule__OutputDataset__RemarksAssignment_9_1_1");
