...
public class AnalysisActivityDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AnalysisActivityDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParameterAccess().getGroup_10_1_0(), "rule__Parameter__Group_10_1_0__0");
			builder.put(grammarAccess.getParameterAccess().getGroup_10_1_1(), "rule__Parameter__Group_10_1_1__0");
			builder.put(grammarAccess.getParameterAccess().getGroup_10_1_1_3(), "rule__Parameter__Group_10_1_1_3__0");
			...
			builder.put(grammarAccess.getActivityAccess().getRemarksAssignment_3_0(), "rule__Activity__RemarksAssignment_3_0");
			...
			builder.put(grammarAccess.getParameterAccess().getRemarksAssignment_10_1_0_0(), "rule__Parameter__RemarksAssignment_10_1_0_0");
			builder.put(grammarAccess.getParameterAccess().getConstraintsAssignment_10_1_1_2(), "rule__Parameter__ConstraintsAssignment_10_1_1_2");
			builder.put(grammarAccess.getParameterAccess().getConstraintsAssignment_10_1_1_3_1(), "rule__Parameter__ConstraintsAssignment_10_1_1_3_1");
			...
			builder.put(grammarAccess.getInputDatasetAccess().getRemarksAssignment_9_1_0_0(), "rule__InputDataset__RemarksAssignment_9_1_0_0");
			...
			builder.put(grammarAccess.getOutputDatasetAccess().getRemarksAssignment_9_1_0_0(), "rule__OutputDataset__RemarksAssignment_9_1_0_0");
			...
			builder.put(grammarAccess.getParameterAccess().getUnorderedGroup_10_1(), "rule__Parameter__UnorderedGroup_10_1");
