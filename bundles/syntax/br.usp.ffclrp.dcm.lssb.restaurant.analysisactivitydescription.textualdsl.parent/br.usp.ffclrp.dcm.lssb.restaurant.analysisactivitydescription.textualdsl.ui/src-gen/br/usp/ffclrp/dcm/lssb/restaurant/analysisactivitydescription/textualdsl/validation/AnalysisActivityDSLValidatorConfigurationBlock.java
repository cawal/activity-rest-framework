...
public class AnalysisActivityDSLValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(AnalysisActivityDSLConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("AnalysisActivityDSL");
		if (section == null) {
			return dialogSettings.addNewSection("AnalysisActivityDSL");
		}
		return section;
	}
}
